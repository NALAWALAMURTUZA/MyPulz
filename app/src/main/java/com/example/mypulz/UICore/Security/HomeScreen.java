...
public class HomeScreen extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_my_appointment) {
            // Handle the camera action

            //startWebView("http://www.google.com");
            Intent i = new Intent(HomeScreen.this,MyAppointment.class);
            startActivity(i);
//            finish();
...
//            finish();
            ...
            //startWebView("http://139.59.247.22/tmf-live/web/index.php?r=centers%2Fgraph-smart-center-distribution");

        } else if (id == R.id.nav_review) {

            Intent i = new Intent(HomeScreen.this,Review.class);
            startActivity(i);
//            finish();
